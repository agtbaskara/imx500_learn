...
def get_args():
    ...
    parser.add_argument("--model", type=str, help="Path of the model",
                        default="/home/pi/dev/imx500_learn/mnist_imx500/model/network.rpk")
...
if __name__ == "__main__":
    ...
    config = picam2.create_preview_configuration(controls={"FrameRate": intrinsics.inference_rate, "CnnEnableInputTensor": True}, buffer_count=12)
    ...
    while True:
        ...
        output_tensor = picam2.capture_metadata()["CnnOutputTensor"]
        print("Output Tensor:", output_tensor)

        probs = softmax(output_tensor)
        print("Softmax Tensor:", probs)
